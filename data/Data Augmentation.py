...
subset_images = x_train[:40]
batch_size = 40

data_generator = ImageDataGenerator(rotation_range=15)
augmented_images_batch = next(data_generator.flow(subset_images, batch_size=batch_size, seed=3213))
...
zoomed_images_batch = next(zoom_generator.flow(subset_images, batch_size=batch_size, seed=3213))
